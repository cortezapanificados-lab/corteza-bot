...
> **Agroecológico es el titular de la marca. Masa madre es un dato del producto.**

**Por qué en ese orden:**

1. **El agroecológico aplica a TODO, sin excepción.** Es lo único que se puede afirmar sin asteriscos, y las afirmaciones sin asteriscos son las que construyen confianza.
...
**La consistencia exacta es lo que hace creíble el reclamo.** Un cliente que ve que decís la verdad en un detalle chico te cree el resto.

---

## Dónde va, por orden de importancia

### 1. Una línea fija arriba de cada descripción de producto

Siempre en el mismo lugar, siempre con el mismo formato. **La repetición exacta es lo que la hace escaneable y creíble.**

**Masa madre · Harina 100% agroecológica**

**Harina 100% agroecológica**

*(Una u otra según el producto — el mapeo completo está abajo.)*

### 2. Sello en la foto del producto

Dos sellos, mismo diseño, esquina superior: **AGROECOLÓGICO** y **MASA MADRE**. Se ven en la grilla de productos **sin que haga falta abrir la ficha**, que es donde la mayoría decide en qué clickear.

💡 **Reutilizar el diseño de los sellos que ya tiene la placa de "Sobre Corteza"** — así la tienda entera habla el mismo idioma visual.
...
> **Harina 100% agroecológica**
> En todos nuestros panificados, sin excepción. Trigo cultivado sin agroquímicos.

**La palabra que trabaja acá es "sin excepción".** Es una promesa verificable, y por eso vale más que cualquier adjetivo.

⚠️ **Ojo con el verbo:** nunca "en todo lo que horneamos" — Corteza no hornea, elige. Es el mismo error que hay que corregir en la página "Ustedes".

### 5. Explicá qué significa agroecológico

Mucha gente no sabe qué es, y lo que no se entiende no se paga. Alcanza con una línea, en el bloque del inicio y en "Sobre Corteza":

> *Trigo cultivado sin agroquímicos.*

---

## El mapeo producto por producto

| Producto | Línea que va en la ficha |
|---|---|
...
| Cookies con chips y nuez | **Harina 100% agroecológica** |

**Los productos de terceros (almacén, vinoteca, dips, té) no llevan ninguna de las dos líneas.** Son orgánicos o artesanales, que es otra cosa: mezclarlos diluye el reclamo.
