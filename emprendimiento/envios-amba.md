...
3. ✅ **El primer mes no paga el mínimo.** Con el lanzamiento el **jueves 24/9**, septiembre tiene un solo despacho y **Flexit cobra solo los envíos despachados** (confirmado el 07/09). El objetivo son 30 pedidos ese día y el mes cierra en positivo desde los 18 — cuenta en `numeros.md` sección 3 bis. **El mínimo de 120 empieza a correr en octubre**, que tiene 5 jueves: ahí sí hacen falta 24 por jueves solo para no pagar envíos fantasma.
