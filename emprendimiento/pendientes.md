...
- [ ] 🔥 **ARREGLAR LA PÁGINA DE INICIO: hoy no muestra un solo producto** *(relevada el 07/09)*. Es el problema más caro que tiene la tienda de cara al lanzamiento, porque **es donde cae todo el tráfico de Meta**. Hoy el Inicio es: barra de anuncio → carrusel de categorías → formulario de newsletter → tres bloques genéricos ("Enviamos tu compra", "Pagá como quieras", "Comprá con seguridad") → pie. **Hay que hacer dos clics para ver un pan con precio.** La página de Productos, en cambio, está bien: 16 productos por página con foto, precio, filtros y variantes.
  - **No es "Inicio o Productos": el Inicio tiene que ser las dos cosas.** Mandar la home directo al catálogo pierde el único lugar donde se puede decir qué es Corteza en cinco segundos, y alguien de CABA que nunca escuchó la marca no gasta $28.000 en un listado pelado.
  - [ ] **Sumar "Productos destacados" al Inicio**, arriba de todo lo demás (Panel → Mi Tiendanube → Diseño). 6 u 8 productos con precio. **Es el cambio de una tarde y el de mayor retorno de toda la lista.**
  - [ ] **Reemplazar los tres bloques genéricos** por los tres diferenciales reales: *"Nosotros no horneamos. Elegimos."* / *"Pedís el lunes, comés pan del jueves."* / *"4,9 estrellas"* con link a Ustedes. Hoy ese lugar —el más visible de la página— dice lo mismo que cualquier tienda de Tiendanube.
  - [ ] **Bajar el formulario de newsletter**, que hoy está antes que cualquier producto.
